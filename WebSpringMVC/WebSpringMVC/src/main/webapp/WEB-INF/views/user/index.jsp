	...
	<div class="row">
		<div id="sidebar" class="span3">
			...
			<div class="well well-small alert alert-warning cntr">
				<h2>Giảm Giá 50%</h2>
				<p>
					Chỉ có giá trị cho đặt hàng trực tuyến. <br> <br> <a
			...
			<ul class="nav nav-list promowrapper">
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							title="add to cart"><span class="icon-search"></span> Xem Qua</a>
						<img src="<c:url value="/assets/user/img/dongho3.jpg"/>" alt="">
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							title="add to cart"><span class="icon-search"></span> Xem Qua</a>
						<img src="<c:url value="/assets/user/img/dongho4.jpg"/>" alt="">
						<div class="caption">
							<h4>
								<a class="defaultBtn" href="product_details.html">VIEW</a> <span
									class="pull-right">$22.00</span>
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							title="add to cart"><span class="icon-search"></span> Xem Qua</a>
						<img src="<c:url value="/assets/user/img/dongho2.jpg"/>" alt="">
						<div class="caption">
							<h4>
								<a class="defaultBtn" href="product_details.html">VIEW</a> <span
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							title="add to cart"><span class="icon-search"></span> Xem Qua</a>
						<img src="<c:url value="/assets/user/img/dongho1.jpg"/>" alt="">
						<div class="caption">
							<h4>
								<a class="defaultBtn" href="product_details.html">VIEW</a> <span
									class="pull-right">$ </span>
								...
								<li class="span3">
									<div class="thumbnail">
										<a class="zoomTool" href="product_details.html"
											...
											src="<c:url value="/assets/user/sanphamnoibat/${ item.img }"/>" alt=""></a>
									</div>
								</li>
