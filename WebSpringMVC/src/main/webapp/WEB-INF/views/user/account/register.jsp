						...
						<form:form action="dang-ky" method="POST" modelAttribute="user">
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<form:input class="span3" type="hoten"
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<form:input class="span3" type="diachi"
					...
					<div class="well">
						<h5>Đăng Nhập Hệ Thống</h5>
							...
							<div class="control-group">
								...
								<div class="controls">
								<form:input type="password" class="password" placeholder="Mời Nhập Password" path="password" />
